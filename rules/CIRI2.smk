rule mapping_CIRI2:
    ...
    output:
        sam = "results/{sample}/CIRI2/{sample}.sam",
        log = "results/{sample}/CIRI2/{sample}_mapping.log",
        time = "results/{sample}/CIRI2/time1.txt"
    params:
        bwa = "ref/bwa/hg19",
        time = "results/{sample}/CIRI2/time1.txt"
    conda:
...
rule detect_CIRI2:
    input:
        sam = "results/{sample}/CIRI2/{sample}.sam"
    output:
        outfile = "results/{sample}/CIRI2/{sample}.out",
        log = "results/{sample}/CIRI2/{sample}.out.log",
        time = "results/{sample}/CIRI2/time2.txt"
    params:
...
rule compile_time_CIRI2:
    input:
        time1 = "results/{sample}/CIRI2/time1.txt",
        time2 = "results/{sample}/CIRI2/time2.txt",
    output:
        time = "results/{sample}/CIRI2/time.txt"
    script:
